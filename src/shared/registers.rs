...
impl LongRegisters {
    pub fn to_bytecode(&self) -> u8 {
        match self {
            ...
            LongRegisters::SP => {0x1}

            LongRegisters::LL1 => {0x2}
            LongRegisters::LL2 => {0x3}

            LongRegisters::GP1 => {0x4}
            LongRegisters::GP2 => {0x5}
            LongRegisters::GP3 => {0x6}
        }
    }
    ...
    pub fn from_bytecode(code: u8) -> LongRegisters {
        match code {
            ...
            0x1 => LongRegisters::SP,

            0x2 => LongRegisters::LL1,
            0x3 => LongRegisters::LL2,

            0x4 => LongRegisters::GP1,
            0x5 => LongRegisters::GP2,
            0x6 => LongRegisters::GP3,
            _ => panic!("Uh... Corrupted program ig"),
        }
    }

    pub fn all() -> Vec<LongRegisters> {
        vec![LongRegisters::PC, LongRegisters::SP, LongRegisters::LL1, LongRegisters::LL2,
